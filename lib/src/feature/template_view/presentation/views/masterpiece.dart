...
class MasterpieceView extends StatefulWidget {
  const MasterpieceView({super.key});
          ...
          child: Container(
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: <Widget> [
                  Text('We are creating a masterpiece...',
                    ...
                    builder: (context, consumerValue, child) {
                      ...
                      return CircularPercentIndicator(
                        ...
                        children: [
                          ...
                          Text('${consumerValue.getCurrentTimeRemained} sec',
                          style: AppStyles.head1TextStyle,)
                        ],
                      ),);
                    }
                  ...
                  Text('You will receive a notification when everything is ready!',
                  style: AppStyles.subTitleTextStyle,
                  textAlign: TextAlign.center,)
                ],
              ),
